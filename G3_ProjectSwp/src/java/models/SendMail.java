...
//    generateMailMessage.addRecipient(Message.RecipientType.CC, new InternetAddress("cc@gmail.com")); //Địa chỉ cc gmail
    ...
    public void sendActiveSuccess(String toEmail) throws AddressException, MessagingException {
      Properties mailServerProperties;
    Session getMailSession;
    MimeMessage mailMessage;
...
//    generateMailMessage.addRecipient(Message.RecipientType.CC, new InternetAddress("cc@gmail.com")); //Địa chỉ cc gmail
    ...
    mailMessage.setSubject("Your account activated successfully!");//
    mailMessage.setText("Dear our employee!\nYour account has been activated successfully\nGo to your account and update your information.!");
